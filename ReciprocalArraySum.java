...
//
//        // Compute sum of reciprocals of array elements
//        ReciprocalArraySumTask L = new ReciprocalArraySumTask(mid, input.length, input);
//        ReciprocalArraySumTask R = new ReciprocalArraySumTask(0, mid, input);
//        L.fork();
//        R.compute();
//        L.join();
//        return L.getValue() + R.getValue();
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        for (int i = 0; i < numTasks; i++) {
            ...
            tasks[i] = new ReciprocalArraySumTask(chunkStart, chunkEnd, input);
        }
        for (int i  = 0; i < numTasks; i++) {
            ForkJoinPool.commonPool().invoke(tasks[i]);
        }
        for (int i  = 0; i < numTasks; i++) {
